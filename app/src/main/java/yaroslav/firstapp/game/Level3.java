...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.text_desription3);

        ImageView previewimg = (ImageView)dialog.findViewById(R.id.previewimg);
        previewimg.setImageResource(R.drawable.ballgool);
        ...
        textdescriptionEnd.setText(R.string.text_descriptionEnd3);
        ...
        text_left.setText(array.text_levels3[numLeft]);
        ...
        text_right.setText(array.text_levels3[numRight]);
