...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.text_desription2);

        ImageView previewimg = (ImageView)dialog.findViewById(R.id.previewimg);
        previewimg.setImageResource(R.drawable.player);
        ...
        textdescriptionEnd.setText(R.string.text_descriptionEnd2);
        ...
        text_left.setText(array.text_levels2[numLeft]);
        ...
        text_right.setText(array.text_levels2[numRight]);
